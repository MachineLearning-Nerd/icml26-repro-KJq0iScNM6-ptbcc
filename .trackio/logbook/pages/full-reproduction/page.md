...
---
<!-- trackio-cell
{"type": "code", "id": "cell_06bf2cb52f62", "created_at": "2026-07-16T15:08:28+00:00", "title": "Run: python run_ptbcc.py (exit 0)", "command": ["python", "repro/src/run_ptbcc.py", "--synthetic-seeds", "40", "--ablation-seeds", "3", "--output-dir", "outputs/full"], "exit_code": 0, "duration_s": 76.127}
-->
````bash
$ python repro/src/run_ptbcc.py --synthetic-seeds 40 --ablation-seeds 3 --output-dir outputs/full
````

exit 0 · 76.1s


````python title=run_ptbcc.py
#!/usr/bin/env python3
# /// script
...
````output
{
  ...
  "public_dataset_macro_accuracy": {
    "mv": 0.7657033449083962,
    "ds": 0.7732996365754999,
    "ptbcc": 0.7931170116404941
  },
  "public_dataset_ptbcc_minus_mv_pp": 2.7413666732097886,
  "synthetic": {
    "trials": 40,
    "ptbcc_wins_vs_mv": 40,
    "mean_mv_accuracy": 0.9389687500000001,
    "mean_ptbcc_accuracy": 0.9813124999999999,
    "mean_prototype_mae": 0.04175231402229045
  },
  "claim_audit": {
    "source_sha256_note": "arXiv:2508.02123v1 source downloaded 2026-07-15",
    "text_probes": {
      "paper_method_name_ptbcc": true,
      "paper_says_11_datasets": true,
      "paper_says_15_percent": true,
      "paper_contains_26_percent": false,
      "paper_contains_68_73": false,
      "paper_contains_74_11": false
    },
    "reported_table4": {
      "MV": 0.6986,
      "BWA": 0.7132,
    ...
    "reported_table4_checks": {
      "ptbcc_minus_mv_percentage_points": 4.859999999999998,
      "ptbcc_minus_best_baseline_percentage_points": 2.969999999999995,
      "ptbcc_relative_gain_over_mv_percent": 6.956770684225599
    },
    "reported_table5_prototype_ablation": {
      "2": 0.7472,
      "3": 0.73,
      "4": 0.7271,
      "5": 0.7259,
...
---
<!-- trackio-cell
{"type": "artifact", "id": "cell_571446d8ad51", "created_at": "2026-07-16T15:08:28+00:00", "title": "Artifact: ground_truth_predictions.csv", "path": "outputs/full/ground_truth_predictions.csv", "size": 215758, "artifact_type": "dataset", "auto": true}
-->
**📦 Artifact** `outputs/full/ground_truth_predictions.csv` · dataset · 0.2 MB

https://huggingface.co/buckets/DineshAI/KJq0iScNM6-artifacts#logbook-files/outputs/full/ground_truth_predictions.csv


---
<!-- trackio-cell
{"type": "artifact", "id": "cell_699e8c612a8f", "created_at": "2026-07-16T15:08:28+00:00", "title": "Artifact: annotator_weights.csv", "path": "outputs/full/annotator_weights.csv", "size": 121107, "artifact_type": "dataset", "auto": true}
-->
**📦 Artifact** `outputs/full/annotator_weights.csv` · dataset · 0.1 MB

https://huggingface.co/buckets/DineshAI/KJq0iScNM6-artifacts#logbook-files/outputs/full/annotator_weights.csv


---
<!-- trackio-cell
{"type": "artifact", "id": "cell_ca8ed4e8952f", "created_at": "2026-07-16T15:08:28+00:00", "title": "Artifact: learned_prototypes.csv", "path": "outputs/full/learned_prototypes.csv", "size": 12246, "artifact_type": "dataset", "auto": true}
-->
**📦 Artifact** `outputs/full/learned_prototypes.csv` · dataset · 12.2 kB

https://huggingface.co/buckets/DineshAI/KJq0iScNM6-artifacts#logbook-files/outputs/full/learned_prototypes.csv


---
<!-- trackio-cell
{"type": "artifact", "id": "cell_a74caf7238c0", "created_at": "2026-07-16T15:08:28+00:00", "title": "Artifact: synthetic_recovery_trials.csv", "path": "outputs/full/synthetic_recovery_trials.csv", "size": 2727, "artifact_type": "dataset", "auto": true}
-->
**📦 Artifact** `outputs/full/synthetic_recovery_trials.csv` · dataset · 2.7 kB

https://huggingface.co/buckets/DineshAI/KJq0iScNM6-artifacts#logbook-files/outputs/full/synthetic_recovery_trials.csv


---
<!-- trackio-cell
{"type": "artifact", "id": "cell_a1bd44124d08", "created_at": "2026-07-16T15:08:28+00:00", "title": "Artifact: prototype_count_ablation.csv", "path": "outputs/full/prototype_count_ablation.csv", "size": 2411, "artifact_type": "dataset", "auto": true}
-->
**📦 Artifact** `outputs/full/prototype_count_ablation.csv` · dataset · 2.4 kB

https://huggingface.co/buckets/DineshAI/KJq0iScNM6-artifacts#logbook-files/outputs/full/prototype_count_ablation.csv


---
<!-- trackio-cell
{"type": "artifact", "id": "cell_91fc322754bc", "created_at": "2026-07-16T15:08:28+00:00", "title": "Artifact: public_dataset_results.csv", "path": "outputs/full/public_dataset_results.csv", "size": 1402, "artifact_type": "dataset", "auto": true}
-->
**📦 Artifact** `outputs/full/public_dataset_results.csv` · dataset · 1.4 kB

https://huggingface.co/buckets/DineshAI/KJq0iScNM6-artifacts#logbook-files/outputs/full/public_dataset_results.csv
